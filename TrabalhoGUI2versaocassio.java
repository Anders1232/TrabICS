...
public class TrabalhoGUI2 extends JFrame implements Runnable {
	...
	public void mostraEventos(){
		...
		JTable TabelaDeEventos = obterTabelaDeEventos();
		
		JScrollPane scrollPaneEventos = new JScrollPane(TabelaDeEventos);
		TabelaDeEventos.setFillsViewportHeight(true);
		
		//Cria e configura a janela
        JFrame frameEventos = new JFrame("Tabela de Eventos");
        frameEventos.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        frameEventos.setPreferredSize(new Dimension (450, 400));
        frameEventos.setIconImage(frameIcon.getImage());

        //Cria e configura o painel com conteudos
        frameEventos.add(scrollPaneEventos);
	...
	public void mostraParam(){
		...
		//System.out.println(getTonalidade(trilhas[0]));
